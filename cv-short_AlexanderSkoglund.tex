...
{\bf Currently learning:} Machine Learning using TinyML (Python).
...
{\bf InMotion/West Forest}, Stockholm, Sweden\\
%\vspace{-.3cm}
{\em Senior Embedded Systems Engineer} \hfill {\bf From
  2020-03}\\ Working with firmware requirements, implementation,
testing and verification.  Main area is Functional Safety of inverters
for a motor control system. Firmware must full fill ISO 26262
requirements.
...
%\vspace{-.3cm}
{\em Senior Embedded Systems Engineer} \hfill {\bf From 2019-04 -- 2020-03}\\
