...
\begin{resume}
\hspace{-34mm}
{\bf \large Senior Embedded Systems Engineer, self-employed at E$^2$ FirmwareLabs Design AB}
...
\begin{tabular}{@{}p{3in}p{3in}}
  ...
  172 62 Sundbyberg & {\it E-mail:} alexander.skoglund@e2labs.eu \\
...
UART, RS232, CAN, USB, MQTT, TCP/IP sockets.\\ {\em Electronic design:}
...
{\bf Microcontrollers and boards} ARM Cortex M0/M4/M7 (XMC44XX, STM32 family, 
Blue\-NRG), AVR (STK500, Ar\-du\-ino etc.), MSP430 (TI
Lau\-nch\-Pad), STM8 and Mic\-ro\-ch\-ip dsPIC33EP.
...
Embedded software development for SafeLine's emergency telephones, focusing on ARM Cortex-based device operation and cloud connectivity.\\
{\bf Tools/techniques} used: GCC toolchain, Make, git, gdb, embedded C, Python, Unity and CMock (unit testing), Docker, MQTT, Telit module.

{\bf E$^2$ FirmwareLabs}, Stockholm, Sweden\\
%\vspace{-0mm}
{\em Hardware Engineer} \hfill {\bf From 2021-04}\\
PCB design and layout for a client's project with analog components. Used JLC for prototype production. Maintained BOM and sourced components. Investigated new product design ideas for Ethernet connectivity.\\
{\bf Tools/techniques} used is KiCad.

{\em Senior Embedded Systems Engineer} \hfill {\bf From 2024-10}\\
Embedded software development for a client's connected amplifier products using ARM Cortex and Wiznet W5500 for device operation and connectivity.\\
{\bf Tools/techniques} used: GCC toolchain, Make, git, gdb, embedded C, STM32 IDE, Unity and CMock (unit testing).
...
{\em Firmware/hardware Engineer} \hfill {\bf 2014-02 --
  2017-02}\\ Working on mainly with electronic design and some firmware 
  on Bio\-Ser\-vo's
...
During my Ph.D. I did research in imitation learning, where
